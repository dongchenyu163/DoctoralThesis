...
\begin{figure}[!t]
  \centering
  \includegraphics[width=0.75\linewidth]{fig/chp_peeling/chp4_force_feedback_graph.png}
  \caption{The graph of force feedback equation \ref{eq:peeling_vz}}
  \label{fig:peeling_force_feedback_graph}
\end{figure}
図\ref{fig:peeling_force_feedback_graph}式(\ref{eq:peeling_vz})の関数形は，基本的に $v_z$ と $f_e$ の間に線形に近い関係を持たせつつ，$f_e \approx 0$ 付近で不感帯を形成するように設計されている．
