...
% \newcommand{\namefingerpoint}{finger position}
% \newcommand{\namefingerforce}{finger force}
% \newcommand{\nameholdingpointset}{holding point set}
% \newcommand{\namesearchspace}{search space}
% \newcommand{\namegraspforce}{holding force}

% \newcommand{\namegraspforcetitle}{HoldingForce}
% \newcommand{\namefingerpointcap}{Finger position}
% \newcommand{\namefingerforcecap}{Finger force}
% \newcommand{\nameholdingpointsetcap}{Holding point set}
% \newcommand{\namesearchspacecap}{Search space}
% \newcommand{\namegraspforcecap}{Holding force} % TODO: 重大问题，原文中有2种解释。。。6*1的合力 以及 3n*1指力列向量;
